...
func validateInputsK2(request *DepositEnygmak2Request) error {
...
func validateInputsK3(request *DepositEnygmak3Request) error {
	return validateInputsGeneric(request.AnonymitySet[:], request.SenderID, request.PreviousSenderBalance, request.PreviousSenderRandomValue, convertCommitArray(request.PreviousCommits[:]))
}

func validateInputsK4(request *DepositEnygmak4Request) error {
	return validateInputsGeneric(request.AnonymitySet[:], request.SenderID, request.PreviousSenderBalance, request.PreviousSenderRandomValue, convertCommitArray(request.PreviousCommits[:]))
}

func validateInputsK5(request *DepositEnygmak5Request) error {
	return validateInputsGeneric(request.AnonymitySet[:], request.SenderID, request.PreviousSenderBalance, request.PreviousSenderRandomValue, convertCommitArray(request.PreviousCommits[:]))
}

func validateInputsK6(request *DepositEnygmak6Request) error {
	return validateInputsGeneric(request.AnonymitySet[:], request.SenderID, request.PreviousSenderBalance, request.PreviousSenderRandomValue, convertCommitArray(request.PreviousCommits[:]))
}
...
func handleK2(c *gin.Context, compiled *CompiledCircuit, totalStart time.Time) {
	var request DepositEnygmak2Request
	...
	var witness DepositEnygmak2Circuit
...
func handleK3(c *gin.Context, compiled *CompiledCircuit, totalStart time.Time) {
	var request DepositEnygmak3Request
	if err := c.ShouldBindJSON(&request); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
	...
	var witness DepositEnygmak3Circuit
...
func handleK4(c *gin.Context, compiled *CompiledCircuit, totalStart time.Time) {
	var request DepositEnygmak4Request
	if err := c.ShouldBindJSON(&request); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
	...
	var witness DepositEnygmak4Circuit
...
func handleK5(c *gin.Context, compiled *CompiledCircuit, totalStart time.Time) {
	var request DepositEnygmak5Request
	if err := c.ShouldBindJSON(&request); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
	...
	var witness DepositEnygmak5Circuit
...
func handleK6(c *gin.Context, compiled *CompiledCircuit, totalStart time.Time) {
	var request DepositEnygmak6Request
	if err := c.ShouldBindJSON(&request); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
	...
	var witness DepositEnygmak6Circuit
...
func generateProofGeneric(witness frontend.Circuit, compiled *CompiledCircuit) (*DepositResponseAPI, []string, error) {
...
func generateProofK2(witness frontend.Circuit, compiled *CompiledCircuit, request *DepositEnygmak2Request) (*DepositResponseAPI, error) {
...
func generateProofK3(witness frontend.Circuit, compiled *CompiledCircuit, request *DepositEnygmak3Request) (*DepositResponseAPI, error) {
	response, _, err := generateProofGeneric(witness, compiled)
	if err != nil {
		return nil, err
	}
...
func generateProofK4(witness frontend.Circuit, compiled *CompiledCircuit, request *DepositEnygmak4Request) (*DepositResponseAPI, error) {
	response, _, err := generateProofGeneric(witness, compiled)
	if err != nil {
		return nil, err
	}
...
func generateProofK5(witness frontend.Circuit, compiled *CompiledCircuit, request *DepositEnygmak5Request) (*DepositResponseAPI, error) {
	response, _, err := generateProofGeneric(witness, compiled)
	if err != nil {
		return nil, err
	}
...
func generateProofK6(witness frontend.Circuit, compiled *CompiledCircuit, request *DepositEnygmak6Request) (*DepositResponseAPI, error) {
	response, _, err := generateProofGeneric(witness, compiled)
	if err != nil {
		return nil, err
	}
...
func setWitness2Optimized(witness *DepositEnygmak2Circuit, request *DepositEnygmak2Request) {
	...
	witness.Hash = parseBigIntOptimized(request.Hash)
	witness.Pk = parseBigIntOptimized(request.Pk)
	witness.Address = parseBigIntOptimized(request.Address)
	witness.SaltOut = parseBigIntOptimized(request.SaltOut)
}

func setWitness3Optimized(witness *DepositEnygmak3Circuit, request *DepositEnygmak3Request) {
	witness.SenderId = frontend.Variable(request.SenderID)
	witness.SenderTxValue = parseBigIntOptimized(request.SenderTxValue)
	witness.SecretKey = parseBigIntOptimized(request.SecretKey)
	witness.PreviousSenderBalance = parseBigIntOptimized(request.PreviousSenderBalance)
...
func setWitness4Optimized(witness *DepositEnygmak4Circuit, request *DepositEnygmak4Request) {
	witness.SenderId = frontend.Variable(request.SenderID)
	witness.SenderTxValue = parseBigIntOptimized(request.SenderTxValue)
	witness.SecretKey = parseBigIntOptimized(request.SecretKey)
	witness.PreviousSenderBalance = parseBigIntOptimized(request.PreviousSenderBalance)
...
func setWitness5Optimized(witness *DepositEnygmak5Circuit, request *DepositEnygmak5Request) {
	witness.SenderId = frontend.Variable(request.SenderID)
	witness.SenderTxValue = parseBigIntOptimized(request.SenderTxValue)
	witness.SecretKey = parseBigIntOptimized(request.SecretKey)
	witness.PreviousSenderBalance = parseBigIntOptimized(request.PreviousSenderBalance)
...
func setWitness6Optimized(witness *DepositEnygmak6Circuit, request *DepositEnygmak6Request) {
	witness.SenderId = frontend.Variable(request.SenderID)
	witness.SenderTxValue = parseBigIntOptimized(request.SenderTxValue)
	witness.SecretKey = parseBigIntOptimized(request.SecretKey)
	witness.PreviousSenderBalance = parseBigIntOptimized(request.PreviousSenderBalance)
...
func generatePublicSignal2Optimized(request *DepositEnygmak2Request) []string {
	publicSignal := make([]string, 0, 22)
	...
	publicSignal = append(publicSignal, request.Hash)

	return publicSignal
}

func generatePublicSignal3Optimized(request *DepositEnygmak3Request) []string {
	publicSignal := make([]string, 0, 30)
...
func generatePublicSignal4Optimized(request *DepositEnygmak4Request) []string {
	publicSignal := make([]string, 0, 36)
...
func generatePublicSignal5Optimized(request *DepositEnygmak5Request) []string {
...
func generatePublicSignal6Optimized(request *DepositEnygmak6Request) []string {
