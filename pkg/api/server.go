...
import (
	"enygma-gnark-server/config"
	deposit "enygma-gnark-server/pkg/circuits/enygma/enygma-payments/enygma-deposit"
	transfer "enygma-gnark-server/pkg/circuits/enygma/enygma-payments/enygma-transfer"
	withdraw "enygma-gnark-server/pkg/circuits/enygma/enygma-payments/enygma-withdraw"

	enygma_joinsplit "enygma-gnark-server/pkg/circuits/enygma/enygma-dvp/enygma-joinsplit-dvp"
	erc1155_joinsplit "enygma-gnark-server/pkg/circuits/enygma/enygma-dvp/erc1155-joinsplit-dvp"
	erc721_ownership "enygma-gnark-server/pkg/circuits/enygma/enygma-dvp/erc721-ownership-dvp"
	"net/http"
	"strconv"
