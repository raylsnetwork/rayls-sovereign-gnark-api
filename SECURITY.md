...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-gnark-api/security) of this repository.
...
This policy covers the `rayls-sovereign-gnark-api` service in this repository (the gnark-based
zero-knowledge proving API). Vulnerabilities in the broader Rayls protocol or other components
should be reported against their respective repositories.
...
The service is under active development. Security fixes are released against the **latest
